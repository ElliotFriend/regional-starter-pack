...
<svelte:head>
    ...
    <title>Regional Starter Pack - On/Off Ramp</title>
</svelte:head>

<div class="flex min-h-screen flex-col bg-gray-50">
    <!-- Header -->
    <header class="fixed inset-x-0 top-0 z-20 h-16 border-b border-gray-200 bg-white">
        <div class="flex h-full items-center justify-between px-6">
            <a href="/" class="text-xl font-bold text-indigo-600">Regional Starter Pack</a>
            <WalletConnect />
        </div>
    </header>
    ...
    <div class="flex flex-1 pt-16">
        <!-- Sidebar -->
        <aside
            class="fixed top-16 bottom-0 left-0 z-10 w-64 overflow-y-auto border-r border-gray-200 bg-white"
        >
            <nav class="p-4">
                <!-- Home -->
                <a
