    ...
    <div class="mx-auto max-w-4xl">
        ...
        <div class="mb-8 rounded-lg bg-indigo-50 p-6">
            ...
            <p class="mt-1 text-sm text-indigo-700">
                Experience the on-ramp and off-ramp flows with {anchor.name}'s integration.
            </p>
        ...
        <!-- Integration Notes -->
        <section class="mb-8">
            <h2 class="mb-4 text-xl font-semibold text-gray-900">Integration Notes</h2>
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <ul class="space-y-3 text-sm text-gray-600">
                    ...
                    <li class="flex items-start gap-2">
                        ...
                        <span>API keys required - contact {anchor.name} for access</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <svg
                            class="mt-0.5 h-5 w-5 flex-shrink-0 text-green-500"
